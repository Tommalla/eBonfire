...
server: UDPServer.o TCPDiagnosticServer.o ConnectionsController.o Queue.o server.cpp $(COMMON)
	g++ $(CXX_FLAGS) server.cpp UDPServer.o TCPDiagnosticServer.o ConnectionsController.o Queue.o -o server
